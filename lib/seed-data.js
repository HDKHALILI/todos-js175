...
todoList4.markAllDone();
let todoList5 = new TodoList("general Todos");
todoList5.add(new Todo("Go to Libby's birthday party"));
todoList5.markAllDone();

let todoLists = [todoList1, todoList2, todoList3, todoList4, todoList5];
